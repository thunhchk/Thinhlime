...
toggleButton.Image = "rbxassetid://92722314324124"
...
local Tabs = {
  Main = Window:AddTab({Title = "Tab Farming", Icon = "rbxassetid://92722314324124"}),
  Settings = Window:AddTab({Title = "Tab Setting Farm", Icon = "rbxassetid://92722314324124"}),
  Melee = Window:AddTab({Title = "Tab Auto Get Melee V2", Icon = "rbxassetid://92722314324124"}),
  Quests = Window:AddTab({Title = "Tab Items Farm", Icon = "rbxassetid://92722314324124"}),
  SeaEvent = Window:AddTab({Title = "Tab Sea Events", Icon = "rbxassetid://92722314324124"}),
  Mirage = Window:AddTab({Title = "Tab Mirage + RaceV4", Icon = "rbxassetid://92722314324124"}),
  Drago = Window:AddTab({Title = "Tab Drago Dojo", Icon = "rbxassetid://92722314324124"}),
  Prehistoric = Window:AddTab({Title = "Tab Prehistoric", Icon = "rbxassetid://92722314324124"}),
  Raids = Window:AddTab({Title = "Tab Raid", Icon = "rbxassetid://92722314324124"}),
  Combat = Window:AddTab({Title = "Tab Combat PVP", Icon = "rbxassetid://92722314324124"}),
  Travel = Window:AddTab({Title = "Tab Teleport", Icon = "rbxassetid://92722314324124"}),
  Fruit = Window:AddTab({Title = "Tab Fruits", Icon = "rbxassetid://92722314324124"}),
  Shop = Window:AddTab({Title = "Tab Shop", Icon = "rbxassetid://92722314324124"}),
  Misc = Window:AddTab({Title = "Tab Misc", Icon = "rbxassetid://92722314324124"})
}

Tabs.Main:AddButton({
        Title="Link id tiktok",
        Description="nhớ vô tiktok rồi dán vô",
        Callback=function()
            setclipboard(tostring("@nguyenphuocthinh281989")) 
        end
})
Tabs.Main:AddSection("thinh Đẹp Zai Hẹ Hẹ")
local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "Auto Farm Level", Description = "farm tới level 2750", Default = false})
...
local Bringmob = Tabs.Settings:AddToggle("Bringmob", {Title = "gom quái", Description = "", Default = false})
...
Tabs.Misc:AddButton({Title = "Rain Fruits (Client)", Description = "",Callback = function()
  for i, v in pairs(game:GetObjects("rbxassetid://92722314324124")[1]:GetChildren()) do
